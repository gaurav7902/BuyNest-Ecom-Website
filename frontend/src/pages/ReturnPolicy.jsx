...
const ReturnPolicy = () => {
  return (
    <div className={styles.container}>
      <h2 className={styles.title}>Return & Refund Policy</h2>
      ...
      <h4 className={styles.sectionTitle}>1. Eligibility for Returns</h4>
      ...
      <h4 className={styles.sectionTitle}>2. Refund Processing</h4>
      <p className={styles.sectionText}>
      ...
      <h4 className={styles.sectionTitle}>3. Exempted Output Goods</h4>
      <p className={styles.sectionText}>
      ...
      <h4 className={styles.sectionTitle}>4. Shipping Transit Costs</h4>
      <p>
